...
class config extends bc.baseConfig {
  ...
  public static final String SOURCE_REPO = "https://github.com/brianorwhatever/indy-catalyst.git"
  ...
  public static final String  THEME_REPO = "https://github.com/brianorwhatever/indy-catalyst.git"
